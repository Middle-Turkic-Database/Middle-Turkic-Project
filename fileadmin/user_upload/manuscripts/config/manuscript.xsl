      ...
      <div>
         ...
         <div>
            <ul class="nav nav-tabs" id="manuscriptTabs" role="tablist">
               ...
               <li class="nav-item">
                  <a class="nav-link disabled" id="transcription-tab" data-toggle="tab" href="#transcription" role="tab" aria-controls="transcription" aria-selected="false">Transcription</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link disabled" id="translation-tab" data-toggle="tab" href="#translation" role="tab" aria-controls="translation" aria-selected="false">Translation</a>
               </li>
               <li class="nav-item">
               ...
               <li class="nav-item">
                  <a class="nav-link disabled" id="commentary-tab" data-toggle="tab" href="#commentary" role="tab" aria-controls="commentary" aria-selected="false">Commentary</a>
               </li>
            </ul>
            <div class="tab-content mt-4 ml-3" id="descriptionTabsContent">
...
Download the XML (TEI Epidoc)</a>
               ...
               <div class="tab-pane fade" id="transcription" role="tabpanel" aria-labelledby="transcription-tab">...</div>
               <div class="tab-pane fade" id="translation" role="tabpanel" aria-labelledby="translation-tab">...</div>
               <div class="tab-pane fade" id="parallel" role="tabpanel" aria-labelledby="parallel-tab">...</div>
               <div class="tab-pane fade" id="commentary" role="tabpanel" aria-labelledby="commentary-tab">...</div>
            </div>
         </div>
      </div>
   </xsl:template>
